         ...
         <div class="card">
                <div class="card-header with-border">
                    ...
                    <div class="card-tools">
                        <div class="btn-group float-right mr_5">
                            <a href="{{ sc_route_admin('admin_MultiVendorUser.index') }}" class="btn  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{ sc_language_render('admin.back_list') }}</span></a>
                        </div>
                    </div>
                </div>
                <!-- /.card-header -->
                ...
                <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main"  enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                            ...
                            {{-- select store_id --}}
                            @php
                                $store_id = old('store_id', $vendor['store_id'] ?? 0);
                            @endphp
                            ...
                            <div class="form-group row {{ $errors->has('store_id') ? ' text-red' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control store_id select2" 
                            ...
                            <div class="form-group  row">
                                <label for="status" class="col-sm-2  col-form-label">{{ sc_language_render('multi_vendor.status') }}</label>
                                <div class="col-sm-8">
                                    <input class="checkbox" type="checkbox" name="status"  {{ old('status',(empty($vendor['status'])?0:1))?'checked':''}}>
