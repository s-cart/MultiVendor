        ...
        <div class="card-tools">
         ...
         <div class="float-left">
          @if (!empty($removeList))
            ...
            <div class="menu-left">
              <span class="btn btn-flat btn-danger grid-trash" title="{{ sc_language_render('admin.delete') }}"><i class="fas fa-trash-alt"></i></span>
            </div>
          @endif

          @if (!empty($buttonRefresh))
            <div class="menu-left">
              <span class="btn btn-flat btn-primary grid-refresh" title="{{ sc_language_render('admin.refresh') }}"><i class="fas fa-sync-alt"></i></span>
            </div>
          @endif
          ...
          <div class="menu-left">
            <div class="input-group float-right ml-1" style="width: 250px;">
              ...
              <div class="input-group-append">
                  <button title="{{ sc_language_render('admin.sort') }}" id="button_sort" type="submit" class="btn btn-primary"><i class="fas fa-sort-amount-down-alt"></i></button>
              </div>
            </div>
          </div>
          @endif
...
$('.grid-trash').on('click', function() {
  ...
  Swal.mixin({
    ...
    title: '{{ sc_language_render('action.confirm') }}',
    text: "",
    type: 'warning',
