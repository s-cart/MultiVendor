...
<script type="text/javascript">
    ...
    {
        filebrowserImageBrowseUrl: '{{ sc_route_admin('vendor_admin.home').'/'.config('lfm.url_prefix') }}?type=content',
        filebrowserImageUploadUrl: '{{ sc_route_admin('vendor_admin.home').'/'.config('lfm.url_prefix') }}/upload?type=content&_token={{csrf_token()}}',
